...
public class Oauth {
	 ...
	 */
	public String httpsEndPointHost(){
	...
	private String requestBearerToken(String endPointUrlToken) throws IOException{
		...
		try{
			...
			connection.setRequestProperty("User-Agent", "willi_dtcapp");
	 ...
	 */
	public String rateLimitStatus(String endPointLimit) throws IOException{
		HttpsURLConnection connection = null;
		//String getEPH = getEndPointHost(); // Get End Point Host
